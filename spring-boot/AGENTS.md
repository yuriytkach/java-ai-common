...
This repository contains a Java 21+ service built with Spring Boot and Gradle.
...
3. `.agent/shared/spring-boot/rules/FRAMEWORK.md`
...
2. `.agent/shared/spring-boot/rules/TESTING.md`
...
- [ ] Run all integration tests with `./gradlew integrationTest -x test`
- [ ] Run code style and static analysis with `./gradlew check -x test -x integrationTest`
